...
class FileTransport extends Transport {
    ...
    constructor(options: TransportOptions, logPath: string, maxFileSize: number, maxFiles: number) {
        super(options);
...
class SentryTransport extends Transport {
    ...
    constructor(options: TransportOptions, dsn: string, appName: string, appVersion: string) {
        super(options);
        this.dsn = dsn;
