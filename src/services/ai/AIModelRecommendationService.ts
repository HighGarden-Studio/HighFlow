...
const AI_MODELS: AIModel[] = [
    ...
    },
    {
        ...
        strengths: ['코드 생성 최강', '비용 대비 성능 우수', '빠른 응답 속도', '비전 기능 지원'],
    ...
    },
    {
        ...
        maxContextLength: 200000,
        avgResponseTime: 500,
        strengths: ['초고속 응답', '매우 저렴한 비용', '간단한 작업에 적합'],
    ...
    // OpenAI Models
    {
        ...
        strengths: ['균형 잡힌 성능', '강력한 함수 호출', 'JSON 모드 지원', '비전 기능'],
    ...
    },
    {
        ...
        strengths: ['빠른 응답 속도', '멀티모달 통합', '비용 효율적'],
    ...
    },
    {
        ...
        maxContextLength: 128000,
        avgResponseTime: 400,
        strengths: ['매우 저렴', '초고속', '간단한 작업에 적합'],
    ...
    // Google Models
    {
        ...
        strengths: ['초장문 컨텍스트 (1M 토큰)', '매우 저렴한 비용', '빠른 응답'],
    ...
    },
    {
        ...
        capabilities: ['vision', 'code_generation', 'documentation', 'reasoning', 'summarization'],
        tags: ['chat', 'image-analysis', 'multi-modal', 'free-tier'],
        costPer1kInputTokens: 0.00025,
        costPer1kOutputTokens: 0.0005,
        maxContextLength: 32000,
        avgResponseTime: 1500,
        strengths: ['이미지 분석', '저렴한 비용'],
    ...
    // Groq Models
    {
        ...
        avgResponseTime: 300,
        strengths: ['초고속 추론 (LPU)', '매우 저렴한 비용', '실시간 대화에 적합'],
    ...
    // DeepSeek Models
    {
        ...
        avgResponseTime: 1500,
        strengths: ['뛰어난 코드 생성', '매우 저렴', '긴 컨텍스트 지원'],
    ...
    // Local Models
    {
        ...
        strengths: ['무료 (로컬 실행)', '데이터 프라이버시', '오프라인 사용 가능'],
...
export class AIModelRecommendationService {
    ...
    analyzeTask(title: string, description: string): TaskAnalysis {
        ...
        const contextRequirements = {
            ...
            needsVision: /이미지|image|사진|photo|스크린샷|screenshot|디자인|design/i.test(
                fullText
            ),
        ...
        const scoredModels = this.models
            ...
            .map((model) => {
                ...
                if (analysis.complexity === 'high') {
                    ...
                    // 간단한 작업에는 빠른 모델
                    if (
                        ['claude-3-haiku', 'gpt-4o-mini', 'gemini-pro', 'groq-llama-70b'].includes(
                            model.id
                        )
                    ) {
                        score += 10;
