...
export class GoogleDriveIntegration {
  ...
  private skillsCache: Map<string, { skill: Skill; fileId: string; modifiedTime: string }> = new Map();
  private _lastSyncToken: string | null = null;
  private _watchChannelId: string | null = null;
  private _watchExpiration: number | null = null;
