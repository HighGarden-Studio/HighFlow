    ...
    >
        ...
        <template #footer>
            ...
            <div class="mt-2 pt-2 border-t border-gray-100 dark:border-gray-700">
                <button
                    class="w-full px-2 py-1.5 text-xs font-medium rounded bg-slate-600 text-white hover:bg-slate-700 flex items-center justify-center gap-1 shadow-sm"
                    @click="
                        (e) => {
                            e.stopPropagation();
            ...
            <div v-if="!hideExtraActions" class="mt-2 flex flex-wrap gap-1.5">
                <!-- Execute Button (TODO) -->
                <button
                ...
                <!-- Retry Button -->
                <button
                    v-if="task.status === 'done' || task.status === 'in_progress'"
