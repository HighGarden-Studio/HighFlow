...
<template>
  <div
    :class="[
      ...
      isDragOver ? 'border-blue-400 bg-blue-50/50 dark:bg-blue-900/10 scale-[1.02]' : 'border-gray-200 dark:border-gray-700',
    ]"
  ...
  >
    ...
    >
      <div class="text-center">
        ...
        <p class="text-sm font-semibold text-blue-700 dark:text-blue-300 mt-2">
          Drop here
        </p>
      </div>
    </div>
