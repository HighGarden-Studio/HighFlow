...
import type { SubtaskSuggestion } from '../../services/ai/TaskSubdivisionService';
  ...
  >
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-3xl max-h-[90vh] flex flex-col">
      ...
      <div class="flex-1 overflow-y-auto p-6">
        ...
        <!-- AI 제안 이유 (로딩 완료 후) -->
        <div v-if="!isLoadingAI && aiReasoning" class="mb-6 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
        ...
        <!-- Info Box -->
        <div v-if="!isLoadingAI" class="mt-6 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
          <div class="flex gap-3">
            ...
            <div class="text-sm text-blue-800 dark:text-blue-200">
              ...
              <ul class="list-disc list-inside space-y-1">
                ...
                <li>상위 테스크는 실행이 비활성화되고 그룹핑 용도로만 사용됩니다</li>
