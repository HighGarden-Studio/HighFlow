...
const viewOptions = [
  ...
  { id: 'document', label: '문서', icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
  { id: 'design', label: '디자인', icon: 'M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01' },
] as const;
...
function handleRetry() {
  ...
  console.log('Retry with feedback:', allFeedback);
        ...
        <div class="flex h-full flex-col bg-white dark:bg-gray-800 shadow-2xl">
          ...
          <div class="flex-1 overflow-hidden flex flex-col">
            ...
            <div class="flex-1 overflow-y-auto">
              <div class="flex">
                <!-- Line Numbers -->
                <div class="flex-shrink-0 bg-gray-50 dark:bg-gray-900 px-4 py-4 text-right select-none">
                  <div
                    ...
                    :class="{ 'bg-blue-50 dark:bg-blue-900/20': line.hasComment }"
                ...
                <div class="flex-1 px-4 py-4 overflow-x-auto">
                  ...
                  >
                    ...
                    <pre
                      ...
                      :class="{
                        'bg-yellow-50 dark:bg-yellow-900/20': selectedLine === line.number,
                    ...
                    <div
                      v-if="line.hasComment"
                      class="ml-4 mt-1 space-y-2"
                    >
                      <div
                    ...
                    >
                      ...
                      <div class="flex gap-2 mt-2">
                        ...
                        <button
                          ...
                          @click="showCommentInput = false; selectedLine = null"
                        >
                          취소
                        </button>
                      </div>
            ...
            <div class="flex-shrink-0 border-t border-gray-200 dark:border-gray-700 p-4 bg-gray-50 dark:bg-gray-900">
              ...
              <div class="flex items-center justify-between mt-2 text-xs text-gray-500">
                <span>
                  인라인 코멘트 {{ inlineComments.length }}개
                </span>
                <span>
                  Cmd+Enter 또는 Ctrl+Enter로 빠르게 입력
                </span>
              </div>
            </div>
          </div>
            ...
            <div class="flex items-center justify-between gap-4">
              <div class="flex gap-2">
                ...
                >
                  ...
                  재시도 ({{ inlineComments.length + (modificationPrompt ? 1 : 0) }}개 수정사항)
                </button>
