    ...
    >
      <div class="toggle-info">
        <span class="toggle-icon">
          <svg v-if="isOpen" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="icon">
