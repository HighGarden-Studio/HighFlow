        ...
        >
          ...
          <div class="max-h-72 overflow-y-auto">
            ...
            <div v-if="groupedSuggestions.dependency.length > 0" class="p-2">
              ...
              >
                <div class="flex items-center justify-between">
                  <code class="text-sm font-mono text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-900/50 px-1.5 py-0.5 rounded">
                    {{ suggestion.macro }}
                  </code>
            ...
            >
              ...
              <p class="text-sm text-gray-500 dark:text-gray-400">
                의존성 태스크가 없습니다.<br />
                태스크 의존성을 설정하면<br />
                해당 태스크의 결과를 참조할 수 있습니다.
              </p>
            </div>

            <!-- 컨텍스트 변수 -->
            <div v-if="groupedSuggestions.context.length > 0" class="p-2 border-t border-gray-100 dark:border-gray-700">
              <div class="px-2 py-1 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">
                🔤 컨텍스트 변수
              </div>
              <button
              ...
              >
                <div class="flex items-center justify-between">
                  <code class="text-sm font-mono text-green-600 dark:text-green-400 bg-green-50 dark:bg-green-900/50 px-1.5 py-0.5 rounded">
                    {{ suggestion.macro }}
                  </code>
                </div>
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
            ...
            <!-- 시스템 매크로 -->
            <div v-if="groupedSuggestions.system.length > 0" class="p-2 border-t border-gray-100 dark:border-gray-700">
              <div class="px-2 py-1 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">
                ⚙️ 시스템
              </div>
              <button
              ...
              >
                <div class="flex items-center justify-between">
                  <code class="text-sm font-mono text-gray-600 dark:text-gray-400 bg-gray-100 dark:bg-gray-700 px-1.5 py-0.5 rounded">
                    {{ suggestion.macro }}
                  </code>
                </div>
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
          ...
          <div class="p-3 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/50">
            <p class="text-xs text-gray-500 dark:text-gray-400">
              ...
              <code class="bg-gray-200 dark:bg-gray-700 px-1 rounded" v-pre>{{task:ID}}</code> 형식으로 직접 입력할 수도 있습니다.
            </p>
          </div>
        </div>
      </div>
