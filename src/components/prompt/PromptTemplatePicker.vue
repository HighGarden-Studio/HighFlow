...
function getSortedTemplates(): PromptTemplate[] {
    return templates.value.sort((a, b) => b.usageCount - a.usageCount);
}

const sortedTemplates = computed(() => getSortedTemplates());
                ...
                <div class="template-detail">
                    <template v-if="selectedTemplate">
                        ...
                        <div v-if="renderedPrompt" class="preview mt-4">
                            ...
                            <div
                                class="preview-content bg-gray-900 border border-gray-700 rounded-lg p-3"
                            >
                    ...
                    <div v-else class="no-selection">
                        <svg
                            class="w-16 h-16 text-gray-700 mx-auto"
                            fill="none"
                            viewBox="0 0 24 24"
                            stroke="currentColor"
                        >
