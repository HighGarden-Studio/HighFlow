...
watch(() => projectStore.activeProjects, () => {
  fetchTaskSummaries();
}, { deep: true });
...
<template>
  <div class="flex-1 flex flex-col h-full bg-gray-900">
      ...
      <div v-else class="space-y-3">
        ...
        >
          <div class="flex items-center gap-4">
              ...
              <div class="w-32 flex-shrink-0">
                ...
                <div class="h-2 bg-gray-700 rounded-full overflow-hidden">
                  <div
                    ...
                    :style="{ width: `${taskSummaries[project.id]?.progressPercent || 0}%` }"
                  />
                </div>
              </div>
            ...
            :title="deletingProjectId === project.id ? '삭제 중...' : '프로젝트 삭제'"
          >
                <svg
                ...
                <svg
                  ...
                  viewBox="0 0 24 24"
                >
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 7h12M9 7V5a3 3 0 013-3h0a3 3 0 013 3v2m-7 0h8l-1 12H8L7 7z" />
                </svg>
              </button>
          ...
          <div class="flex items-center gap-6 mt-3 pt-3 border-t border-gray-700/50 text-xs text-gray-500">
    ...
    <ProjectInfoModal
      ...
      @edit="() => { closeProjectInfoModal(); /* TODO: open project edit modal */ }"
    />
    ...
    <Teleport to="body">
      ...
      >
        <div class="absolute inset-0 bg-black/70 backdrop-blur-sm" @click="cancelDeleteProject"></div>
        <div class="relative w-full max-w-md bg-gray-900 border border-gray-700 rounded-2xl shadow-2xl overflow-hidden">
          <div class="px-5 py-4 border-b border-gray-800 bg-gradient-to-r from-red-600/20 to-pink-500/10">
            <div class="flex items-center gap-3">
              <div class="w-10 h-10 rounded-xl bg-red-500/20 flex items-center justify-center">
                <svg class="w-6 h-6 text-red-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v4m0 4h.01M4.93 4.93a10 10 0 0114.14 0M4.93 19.07a10 10 0 010-14.14M9 12h6" />
                </svg>
              </div>
              <div>
                <h3 class="text-lg font-semibold text-white">프로젝트 삭제</h3>
                <p class="text-sm text-gray-400">복구할 수 없습니다. 정말 삭제하시겠습니까?</p>
              </div>
            </div>
          </div>
          <div class="px-5 py-4 space-y-3">
            <div class="p-3 rounded-lg bg-gray-800 border border-gray-700">
              <div class="text-sm text-gray-300">
                "{{ projectToDelete.title }}" 프로젝트와 모든 태스크, 데이터가 영구 삭제됩니다.
              </div>
            </div>
          ...
          <div class="px-5 py-3 border-t border-gray-800 bg-gray-900 flex items-center justify-end gap-2">
            <button
            ...
            >
              {{ deletingProjectId === projectToDelete.id ? '삭제 중...' : '확인하고 삭제' }}
            </button>
          </div>
        </div>
      </div>
