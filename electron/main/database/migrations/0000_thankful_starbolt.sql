CREATE TABLE `activities` (
	...
	FOREIGN KEY (`task_project_id`,`task_sequence`) REFERENCES `tasks`(`project_id`,`project_sequence`) ON UPDATE no action ON DELETE cascade
);
...
CREATE TABLE `notifications` (
	...
	FOREIGN KEY (`related_task_project_id`,`related_task_sequence`) REFERENCES `tasks`(`project_id`,`project_sequence`) ON UPDATE no action ON DELETE cascade
);
--> statement-breakpoint
...
CREATE TABLE `tasks` (
	...
	`has_unread_result` integer DEFAULT false NOT NULL,
	...
	FOREIGN KEY (`blocked_by_project_id`,`blocked_by_sequence`) REFERENCES `tasks`(`project_id`,`project_sequence`) ON UPDATE no action ON DELETE set null,
	FOREIGN KEY (`parent_project_id`,`parent_sequence`) REFERENCES `tasks`(`project_id`,`project_sequence`) ON UPDATE no action ON DELETE set null
);
--> statement-breakpoint
...
CREATE INDEX `script_template_created_at_idx` ON `script_templates` (`created_at`);--> statement-breakpoint
...
CREATE INDEX `task_execution_task_idx` ON `task_executions` (`task_project_id`,`task_sequence`);--> statement-breakpoint
